...
function UploadFile() {
  ...
  return (
    <div className='mx-auto max-w-7xl bprimary'>
      ...
      <select id="width" name="width" className='mr-8 bprimary secondary'>
        ...
        <option className='secondary' value="200">200</option>
        <option className='secondary' value="250">250</option>
        <option className='secondary' value="300">300</option>
        <option className='secondary' value="400">400</option>
      ...
      <div className="mt-4 border-4 rounded-md p-4 max-h-screen  ">
        <button
        ...
        <pre className="overflow-x-auto output" style={{ maxHeight: windowHeight - 250 }}>{asciiOutput}</pre>
      </div>
    </div>
  );
}
